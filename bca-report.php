			 ...
			 if($num>0){
			   ...
			   echo '<td>'.$result['pass'].'</td>';
                           echo '<td>'.$result['gender'].'</td>';
                                       $result['image'];
                             echo "<td><a href='studentprofile.php?fn=".$result['name']."&ri=".$result['id']."&rn=".$result['rollno']."&em=".$result['email']."&ps=".$result['pass']."&gn=".$result['gender']."&im=".$result['image']."'  class='view'>PROFILE</a></td>";
             echo "<td><a href='editprocess.php?fn=".$result['name']."&ri=".$result['id']."&rn=".$result['rollno']."&em=".$result['email']."&ps=".$result['pass']."&gn=".$result['gender']."'  class='edit'>EDIT</a></td>";

             echo "<td><a href='deleteprocess.php?id=".$result['id']."'  class='delete'>DELETE</a></td>";
                           echo '</tr>';
				}
			}
			?>
